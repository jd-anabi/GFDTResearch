...
class HairBundleNonDimensional:
    ...
    def __init__(self, tau_hb: float, tau_m: float, tau_gs: float, tau_t: float,
                 ...
                 x_c: float, eta_hb: float, eta_a: float, omega: float, amp: float, vis_amp: float, p_t_steady: bool):
        # parameters
        ...
        def g(x_hb: float, x_a: float, p_m: float, p_gs: float, p_t: float, t: float) -> tuple:
            ...
            return self.hb_noise, self.a_noise0 - x_a * (1 - self.s_min) * self.eta_a, 0, 0, 0

        def g_steady(x_hb: float, x_a: float, p_m: float, p_gs: float, t: float) -> tuple:
            return self.hb_noise, self.a_noise0 - x_a * (1 - self.s_min) * self.eta_a, 0, 0
